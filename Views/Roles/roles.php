...
la primera variable es modalRoles (no s'incorpora el php ja que està concatenat en la funcio), ja que es el nom on esta el desplegable que volem visualitzar al fer click al boto Views\Template\Modals\modalRoles.php
