...
<?php
class Accessoris extends Controllers {
    ...
    public function accessoris() {
        // Capture les dades de productes
        $data['products'] = $this->model->selectProductos(); 
        $data['page_tag'] = "Accessoris";
        $data['page_title'] = "Accessoris";
        $data['page_name'] = "Accessoris";
        $data['page_functions_js'] = "function_index.js";
        $this->views->getViews($this, "accessoris", $data);
    }

        // Obtenic tots els productes amb el nom de la categoria
